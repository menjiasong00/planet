...
func request_Test_MakeCoding_0(ctx context.Context, marshaler runtime.Marshaler, client TestClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq MakeCodingRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.MakeCoding(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Test_MakeCoding_0(ctx context.Context, marshaler runtime.Marshaler, server TestServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq MakeCodingRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.MakeCoding(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterTestHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TestServer) error {
	...
	mux.Handle("POST", pattern_Test_MakeCoding_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_Test_MakeCoding_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Test_MakeCoding_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTestHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TestClient) error {
	...
	mux.Handle("POST", pattern_Test_MakeCoding_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Test_MakeCoding_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_Test_MakeCoding_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"base", "coding"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Test_GetTestMsg_0 = runtime.ForwardResponseMessage

	forward_Test_MakeCoding_0 = runtime.ForwardResponseMessage
)
